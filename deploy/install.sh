#!/bin/bash
#
# ownapi Installation Script
# ownapi 安装脚本
# Set GITHUB_REPO=your-org/ownapi before using this script in production.
#
...
if [ -z "$GITHUB_REPO" ]; then
    echo "GITHUB_REPO is required. Example: GITHUB_REPO=your-org/ownapi $0 install"
    exit 1
fi
...
declare -A MSG_ZH=(
    ...
    # Completion
    ["install_complete"]="ownapi 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 ownapi 服务："
    ...
    ["not_installed"]="ownapi 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 ownapi。"
    ...
    ["uninstall_complete"]="ownapi 已卸载"

    # Help
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 ownapi"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 ownapi"
    ...
    ["server_config_desc"]="配置 ownapi 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="ownapi Installation Script"
    ...
    # Completion
    ["install_complete"]="ownapi installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start ownapi service:"
    ...
    ["not_installed"]="ownapi is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove ownapi from your system."
    ...
    ["uninstall_complete"]="ownapi has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install ownapi"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove ownapi"
    ...
    ["server_config_desc"]="Configure ownapi server listen address"
...
[Unit]
Description=ownapi - AI API Gateway Platform
Documentation=https://github.com/your-org/ownapi
...
# Requires: ownapi must already be installed
install_version() {
