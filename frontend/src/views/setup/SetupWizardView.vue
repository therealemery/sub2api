<template>
  <div
    class="flex min-h-screen items-center justify-center bg-[var(--bg-page)] p-4"
  >
    <div class="w-full max-w-2xl">
      <!-- Logo & Title -->
      <div class="mb-8 text-center">
        <div
          class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-lg bg-[var(--accent)]"
        >
        ...
        <div class="flex items-center justify-center">
          <template v-for="(step, index) in steps" :key="step.id">
              ...
              <div
                :class="[
                  ...
                  currentStep > index
                    ...
                    : currentStep === index
                      ? 'bg-[var(--accent)] text-[var(--text-inverse)] ring-2 ring-[var(--border-focus)]'
                      : 'bg-gray-200 text-gray-500 bg-[var(--bg-surface-alt)] text-[var(--text-muted)]'
                ]"
              >
                <Icon
            ...
            <div
              ...
              :class="currentStep > index ? 'bg-[var(--accent)]' : 'bg-gray-200 bg-[var(--bg-surface-alt)]'"
            ></div>
          </template>
        </div>
      </div>
      ...
      <!-- Step Content -->
      <div class="rounded-lg bg-[var(--bg-surface)] p-8 bg-[var(--bg-surface-alt)]">
        <!-- Step 1: Database -->
