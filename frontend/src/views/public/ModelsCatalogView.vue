                ...
                <div class="model-card-body">
                  ...
                  <div v-if="model.pricingSource" class="pricing-card">
                    ...
                    <div v-if="model.pricingSource.longContext" class="context-toggle" :aria-label="`${model.displayName} ${t('publicModels.longContextThreshold', { count: model.pricingSource.longContext.thresholdTokens.toLocaleString('en-US') })}`">
                      <button type="button" :class="{ active: contextMode(model) === 'short' }" @click.prevent.stop="setContextMode(model, 'short')">{{ t('publicModels.shortContext') }}</button>
                      <button type="button" :class="{ active: contextMode(model) === 'long' }" @click.prevent.stop="setContextMode(model, 'long')">{{ t('publicModels.longContext') }}</button>
                    </div>
                  ...
                  <div class="model-card-footer"><strong>{{ t('publicModels.viewModel') }} <Icon name="arrowRight" size="xs" /></strong></div>
                </div>
              </router-link>
