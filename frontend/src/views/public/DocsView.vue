...
const h3UploadExample = `curl "${baseUrl}/videos" \\
  -H "Authorization: Bearer $OWNAPI_API_KEY" \\
  -F "model=MiniMax-H3" \\
  -F "prompt=Follow the reference motion and audio." \\
  -F "duration=5" \\
  -F "resolution=768p" \\
...
.video-docs-grid h4{margin:20px 0 0;color:#555;font-size:11px;font-weight:650;text-transform:uppercase;letter-spacing:.06em}.video-docs-grid h4+pre{margin-top:10px}
