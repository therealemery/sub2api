...
@media(prefers-reduced-motion:reduce){.docs-page{scroll-behavior:auto}.docs-nav a::before,.on-this-page a::before{transition:none;transform:none}}
</style>
