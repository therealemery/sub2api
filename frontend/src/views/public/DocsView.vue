    ...
    <main class="docs-page">
      <div class="docs-shell">
        <aside class="docs-nav" :class="{ 'docs-nav-open': navigationOpen }">
          ...
          <nav :aria-label="t('publicDocs.navigation')">
            <div v-for="group in docsNavigation" :key="group.labelKey">
              ...
              <a v-for="item in group.items" :key="item.id" :href="item.href" @click="navigationOpen = false">{{ t(item.labelKey) }}</a>
            </div>
          </nav>
        </aside>
        ...
        <article class="docs-content">
          ...
          <section id="resources" class="docs-section resources-section">
            ...
            <div class="resource-links">
              ...
              <router-link to="/monitor"><div><strong>{{ t('publicDocs.statusTitle') }}</strong><p>{{ t('publicDocs.statusDescription') }}</p></div><Icon name="arrowRight" size="sm" /></router-link>
            </div>
          </section>
        </article>
        ...
        <aside class="on-this-page">
          ...
          <a v-for="item in docsOnThisPage" :key="item.id" :href="item.href">{{ t(item.labelKey) }}</a>
        </aside>
      </div>
    </main>
  </PublicSiteLayout>
...
@media(prefers-reduced-motion:reduce){.docs-page{scroll-behavior:auto}}
</style>
