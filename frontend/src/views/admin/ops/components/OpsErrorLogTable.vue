        ...
        <table class="w-full border-separate border-spacing-0">
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            >
              ...
              <!-- Platform -->
              <td class="whitespace-nowrap px-4 py-2">
                <span class="inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 text-[10px] font-bold uppercase text-gray-600 bg-[var(--bg-surface-alt)]">
                  {{ log.platform || '-' }}
                </span>
              </td>
              ...
              <td class="whitespace-nowrap px-4 py-2">
                <div class="flex items-center gap-1.5">
                  ...
                  <span
                    ...
                    class="rounded bg-gray-100 px-1.5 py-0.5 text-[10px] font-bold text-gray-600 bg-[var(--bg-surface-alt)]"
                  >
...
function getTypeBadge(log: OpsErrorLog): { label: string; className: string } {
  ...
  if (phase === 'auth' && owner === 'client') {
    return { label: t('admin.ops.errorLog.typeAuth'), className: 'bg-gray-100 text-gray-700 ring-gray-500/20' }
  }
  if (phase === 'routing' && owner === 'platform') {
    return { label: t('admin.ops.errorLog.typeRouting'), className: 'bg-purple-50 text-purple-700 ring-purple-600/20' }
  }
  if (phase === 'internal' && owner === 'platform') {
    return { label: t('admin.ops.errorLog.typeInternal'), className: 'bg-gray-100 text-gray-800 ring-gray-600/20 bg-[var(--bg-surface-alt)]' }
  }

    const fallback = phase || owner || t('common.unknown')
    return { label: fallback, className: 'bg-gray-50 text-gray-700 ring-gray-600/10 bg-[var(--bg-surface-alt)]' }
}
