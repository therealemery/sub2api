  ...
  <div class="rounded-lg bg-[var(--bg-surface)] p-6 ring-1 ring-gray-900/5 bg-[var(--bg-surface-alt)]">
    <div class="mb-4 flex items-start justify-between gap-4">
      ...
      <div class="flex items-center gap-2">
        ...
        <button
          class="flex items-center gap-1.5 rounded-lg bg-gray-100 px-3 py-1.5 text-xs font-bold text-gray-700 transition-colors hover:bg-gray-200 disabled:cursor-not-allowed disabled:opacity-50 bg-[var(--bg-surface-alt)]"
          :disabled="loading"
          @click="load"
        >
    ...
    <div v-else-if="sortedRules.length === 0" class="rounded-lg border border-dashed border-gray-200 p-8 text-center text-sm text-gray-500 border-[var(--border-default)]">
