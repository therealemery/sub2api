<template>
  <div class="docs-code">
    <div class="code-header">
      ...
      <button type="button" class="copy-button" aria-live="polite" @click="copyCode">
        <Transition name="motion-fade" mode="out-in">
          <span :key="copied ? 'copied' : 'copy'" class="docs-copy-feedback"><Icon :name="copied ? 'check' : 'copy'" size="sm" />{{ copied ? t('publicDocs.copied') : t('publicModels.code.copy') }}</span>
        </Transition>
      </button>
    </div>
