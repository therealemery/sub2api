<template>
  <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 border-[var(--border-default)] bg-[var(--bg-surface-alt)]">
    ...
    <div v-if="mode === 'custom'" class="mt-4 space-y-4">
      ...
      <div v-if="anyOf.length === 0" class="rounded-lg border border-dashed border-gray-300 p-4 text-sm text-gray-500 border-[var(--border-default)] text-[var(--text-muted)]">
      ...
      >
        ...
        <div class="mt-4 space-y-3">
          <div
            ...
            :key="condIndex"
            class="rounded-lg border border-gray-200 bg-gray-50 p-3 border-[var(--border-default)] bg-[var(--bg-surface-alt)]"
          >
