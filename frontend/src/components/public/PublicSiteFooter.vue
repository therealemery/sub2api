...
<style scoped>
.public-footer{display:grid;grid-template-columns:1.2fr 2fr;gap:80px;width:min(100% - 48px,1392px);margin:0 auto;padding:64px 0 24px;border-top:1px solid #e5e5e5}.footer-brand>a{display:inline-flex;align-items:center;gap:10px;color:#171717;text-decoration:none}.footer-brand img{width:26px;height:26px;object-fit:contain;mix-blend-mode:multiply}.footer-brand strong{font-size:16px}.footer-brand p{max-width:360px;margin:20px 0 0;color:#666;font-size:13px;line-height:1.65}.footer-directory{display:grid;grid-template-columns:repeat(3,1fr);gap:30px}.footer-directory>div{display:grid;align-content:start;gap:12px;font-size:13px}.footer-directory strong{margin-bottom:4px}.footer-directory a{color:#666;text-decoration:none}.footer-directory a:hover{color:#000}.footer-bottom{grid-column:1/-1;margin-top:50px;padding-top:22px;border-top:1px solid #e5e5e5}.footer-bottom p{margin:0;color:#8f8f8f;font-size:12px}
@media(max-width:767px){.public-footer{grid-template-columns:1fr;width:calc(100% - 32px);gap:54px}.footer-directory{grid-template-columns:repeat(2,1fr)}}
</style>
