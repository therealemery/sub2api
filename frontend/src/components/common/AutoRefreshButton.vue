<template>
  <div class="relative" ref="dropdownRef">
    <button
      ...
      class="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 bg-[var(--bg-surface)] px-2.5 py-1.5 text-xs font-medium text-gray-700 transition-colors hover:bg-gray-50 border-[var(--border-default)] bg-[var(--bg-surface-alt)]"
