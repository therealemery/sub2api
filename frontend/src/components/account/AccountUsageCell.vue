    ...
    >
      ...
      <div v-else-if="usageInfo" class="space-y-1">
        ...
        <div class="flex items-center gap-1.5 mt-0.5">
          ...
          <button
            type="button"
            class="inline-flex items-center gap-0.5 rounded px-1.5 py-0.5 text-[9px] font-medium text-[var(--accent)] hover:bg-[var(--bg-subtle)] text-[var(--accent)] transition-colors"
    ...
    <template v-else-if="account.platform === 'antigravity' && account.type === 'oauth'">
      ...
      <div v-if="antigravityTierLabel" class="mb-1 flex items-center gap-1">
        ...
        >
          ...
          <span
            class="pointer-events-none absolute left-0 top-full z-50 mt-1 w-80 whitespace-normal break-words rounded bg-gray-900 px-3 py-2 text-xs leading-relaxed text-[var(--text-inverse)] opacity-0 transition-opacity group-hover:opacity-100"
          >
      ...
      <div v-if="isForbidden" class="space-y-1">
        ...
        <div v-if="validationURL" class="flex items-center gap-1">
          <a
            ...
            class="text-[10px] text-[var(--accent)] hover:text-[var(--accent-hover)] hover:underline text-[var(--accent)]"
