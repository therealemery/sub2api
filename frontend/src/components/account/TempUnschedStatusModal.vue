<template>
  ...
  >
    <div class="space-y-4">
      ...
      <div v-else-if="!isActive" class="rounded-lg border border-gray-200 p-4 text-sm text-gray-500 border-[var(--border-default)] dark:text-gray-400">
      ...
      <div v-else class="space-y-4">
        ...
        <div class="rounded-lg border border-gray-200 p-3 border-[var(--border-default)]">
          ...
          <div class="mt-2 rounded bg-gray-50 p-2 text-xs text-gray-700 bg-[var(--bg-surface-alt)] dark:text-gray-300">
            {{ state?.error_message || '-' }}
          </div>
        </div>
      </div>
