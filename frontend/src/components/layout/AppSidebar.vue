...
const SidebarModelIcon = makeSidebarIcon([
  { d: 'm12 3.8 7.1 4.1v8.2L12 20.2l-7.1-4.1V7.9L12 3.8z' },
  { d: 'm12 8.3 3.2 1.85v3.7L12 15.7l-3.2-1.85v-3.7L12 8.3z', accent: true },
])
