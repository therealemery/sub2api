export default {
  ...
  userSubscriptions: {
    ...
    loadUnavailable: '订阅信息暂不可用',
    loadUnavailableDesc: '当前无法读取订阅信息，请稍后刷新或联系管理员。',
    failedToLoad: '加载订阅失败',
    status: {
      active: '有效',
      expired: '已过期',
  ...
  payment: {
    ...
    createOrder: '确认支付',
    rechargeNow: '立即充值',
    rechargeLogicKicker: '充值规则',
    rechargeLogicTitle: '充多少，就到账多少美元额度',
    rechargeLogicDesc: '1 元人民币 = 1 美元额度。主流模型按官方价 6 折使用，充 ¥100 约可使用 $420 官方价 Token 面值。',
    rechargeRuleExchangeLabel: '内部换算',
    rechargeRuleExchange: '1 元 = 1 美元额度',
    rechargeRuleDiscountLabel: '主流模型',
    rechargeRuleDiscount: '约 4.2x 官方价 Token 面值',
    rechargeRuleNote: '这是 OwnAPI 内部额度规则，不是外汇汇率。',
    rechargeTrustLine: '价格透明，模型不注水，长期稳定。',
    rechargePreviewTitle: '充值预估',
    rechargePreviewDesc: '输入金额后，先看你支付多少、到账多少，以及大致可用价值。',
    rechargeBaseAmount: '你支付',
    officialTokenValue: '可用价值',
    discountResult: '折扣结果',
    discountSixOff: '约官方价 6 折',
    methods: {
      easypay: '易支付',
      alipay: '支付宝',
      wxpay: '微信支付',
    ...
    tabSubscribe: '订阅',
    noPlans: '暂无可用订阅套餐',
    notAvailable: '支付配置暂不可用，请联系管理员开通。',
    confirmSubscription: '确认订阅',
    confirmCancel: '确定要取消此订单吗？',
    amountTooLow: '最低金额为 {min}',
    amountTooHigh: '最高金额为 {max}',
    amountNoMethod: '该金额没有可用的支付方式',
    rechargeRatePreview: '1 元人民币 = {usd} 美元额度；主流模型约按 {multiplier}x 官方价 Token 面值估算，实际以模型价格和调用量为准。',
    refundReason: '退款原因',
