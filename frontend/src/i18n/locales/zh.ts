export default {
  ...
  publicModels: {
    ...
    resolution: '分辨率',
    videoPriceEstimate: '官方价格由公开 8 折售价反推，OwnAPI 按官方价 75 折展示。',
    viewProtocol: '查看接口协议',
    videoGenerator: { eyebrow: '登录用户专属', title: '生成 MiniMax H3 视频', apiKey: 'OwnAPI API Key', prompt: '提示词', promptPlaceholder: '描述画面、动作、镜头和风格…', duration: '视频时长', resolution: '分辨率', referenceUrl: '参考图 URL（可选）', referenceFile: '上传参考图（可选）', submit: '生成视频', submitting: '正在创建任务…', status: '任务状态', download: '打开或下载视频', failed: '视频请求失败' },
