export default {
  ...
  publicModels: {
    ...
    resolution: '分辨率',
    videoPriceEstimate: '官网价为 768p：0.5 元/秒、2K：0.8 元/秒，按 6.7 元兑 1 美元换算；OwnAPI 按官方价 75 折计费。',
    viewProtocol: '查看接口协议',
    videoGenerator: { eyebrow: '登录用户专属', title: '生成 MiniMax H3 视频', apiKey: 'OwnAPI API Key', prompt: '提示词', promptPlaceholder: '描述画面、动作、镜头和风格…', duration: '视频时长', resolution: '分辨率', referenceUrl: '参考图 URL（可选）', referenceFile: '上传参考图（可选）', firstFrameUrl: '首帧 URL（可选）', firstFrameFile: '上传首帧（可选）', lastFrameUrl: '尾帧 URL（可选）', lastFrameFile: '上传尾帧（可选）', referenceVideoUrl: '参考视频 URL（可选）', referenceVideoFile: '上传参考视频（可选）', referenceAudioUrl: '参考音频 URL（可选）', referenceAudioFile: '上传参考音频（可选）', submit: '生成视频', submitting: '正在创建任务…', status: '任务状态', download: '打开或下载视频', failed: '视频请求失败' },
