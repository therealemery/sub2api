export default {
  ...
  userSubscriptions: {
    ...
    loadUnavailable: 'Subscription information is unavailable',
    loadUnavailableDesc: 'We cannot load subscription data right now. Please refresh later or contact the administrator.',
    failedToLoad: 'Failed to load subscriptions',
    status: {
      active: 'Active',
      expired: 'Expired',
  ...
  payment: {
    ...
    creditedBalance: 'Credited Quota',
    ...
    rechargeLogicKicker: 'Top-up rule',
    rechargeLogicTitle: 'Your RMB top-up becomes the same USD quota',
    rechargeLogicDesc: '1 RMB = 1 USD quota. Mainstream models run at about 60% of official price, so ¥100 gives roughly $420 in official-price token value.',
    rechargeRuleExchangeLabel: 'Internal conversion',
    rechargeRuleExchange: '1 RMB = 1 USD quota',
    rechargeRuleDiscountLabel: 'Mainstream models',
    rechargeRuleDiscount: 'About 4.2x official-price token value',
    rechargeRuleNote: 'This is an OwnAPI internal quota rule, not an FX rate.',
    rechargeTrustLine: 'Transparent pricing, stable service, no diluted model experience.',
    rechargePreviewTitle: 'Top-up estimate',
    rechargePreviewDesc: 'Check what you pay, what gets credited, and the estimated usable value before paying.',
    rechargeBaseAmount: 'You pay',
    officialTokenValue: 'Usable value',
    discountResult: 'Discount result',
    discountSixOff: 'About 60% of official price',
    methods: {
      easypay: 'EasyPay',
      alipay: 'Alipay',
      wxpay: 'WeChat Pay',
    ...
    currentBalance: 'Current Available Quota',
    ...
    notAvailable: 'Payment is not configured yet. Please contact the administrator.',
    ...
    rechargeRatePreview: '1 RMB = {usd} USD quota. Mainstream models are estimated at {multiplier}x official-price token value; actual usage depends on model price and calls.',
