export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplier: 'Balance Recharge Multiplier (legacy CNY)',
        balanceRechargeMultiplierHint: 'Stripe USD checkout does not use this multiplier; it only applies to legacy CNY flows.',
        balanceRechargePreview: 'Stripe USD checkout: 1 USD = 1 USD balance',
        ...
        rechargeFeePreview: 'Preview: Recharge 100 USD, fee {fee} USD',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to ownapi',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the ownapi AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current USD checkout: 1 USD = 1 USD balance',
