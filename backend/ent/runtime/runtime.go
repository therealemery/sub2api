...
func init() {
	...
	// usagelogDescConditionMultiplier is the schema descriptor for condition_multiplier field.
	usagelogDescConditionMultiplier := usagelogFields[27].Descriptor()
	// usagelog.DefaultConditionMultiplier holds the default value on creation for the condition_multiplier field.
	usagelog.DefaultConditionMultiplier = usagelogDescConditionMultiplier.Default.(float64)
	// usagelog.ConditionMultiplierValidator is a validator for the "condition_multiplier" field. It is called by the builders before save.
	usagelog.ConditionMultiplierValidator = usagelogDescConditionMultiplier.Validators[0].(func(float64) error)
	// usagelogDescPricingRuleID is the schema descriptor for pricing_rule_id field.
	usagelogDescPricingRuleID := usagelogFields[28].Descriptor()
	// usagelog.PricingRuleIDValidator is a validator for the "pricing_rule_id" field. It is called by the builders before save.
	usagelog.PricingRuleIDValidator = usagelogDescPricingRuleID.Validators[0].(func(string) error)
