...
type UsageLog struct {
	...
	// PricingEffectiveAt holds the value of the "pricing_effective_at" field.
	PricingEffectiveAt *time.Time `json:"pricing_effective_at,omitempty"`
	// ConditionMultiplier holds the value of the "condition_multiplier" field.
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldInputCost, usagelog.FieldOutputCost, usagelog.FieldCacheCreationCost, usagelog.FieldCacheReadCost, usagelog.FieldTotalCost, usagelog.FieldActualCost, usagelog.FieldRateMultiplier, usagelog.FieldConditionMultiplier, usagelog.FieldAccountRateMultiplier:
			values[i] = new(sql.NullFloat64)
		case usagelog.FieldID, usagelog.FieldUserID, usagelog.FieldAPIKeyID, usagelog.FieldAccountID, usagelog.FieldChannelID, usagelog.FieldGroupID, usagelog.FieldSubscriptionID, usagelog.FieldInputTokens, usagelog.FieldOutputTokens, usagelog.FieldCacheCreationTokens, usagelog.FieldCacheReadTokens, usagelog.FieldCacheCreation5mTokens, usagelog.FieldCacheCreation1hTokens, usagelog.FieldBillingType, usagelog.FieldDurationMs, usagelog.FieldFirstTokenMs, usagelog.FieldImageCount:
			values[i] = new(sql.NullInt64)
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldPricingRuleID, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize:
			values[i] = new(sql.NullString)
		case usagelog.FieldPricingEffectiveAt, usagelog.FieldCreatedAt:
	...
	for i := range columns {
		...
		case usagelog.FieldPricingEffectiveAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field pricing_effective_at", values[i])
			} else if value.Valid {
				_m.PricingEffectiveAt = new(time.Time)
				*_m.PricingEffectiveAt = value.Time
			}
		case usagelog.FieldConditionMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field condition_multiplier", values[i])
			} else if value.Valid {
				_m.ConditionMultiplier = value.Float64
			}
		case usagelog.FieldPricingRuleID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field pricing_rule_id", values[i])
			} else if value.Valid {
				_m.PricingRuleID = new(string)
				*_m.PricingRuleID = value.String
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.PricingEffectiveAt; v != nil {
		builder.WriteString("pricing_effective_at=")
		builder.WriteString(v.Format(time.ANSIC))
	}
	builder.WriteString(", ")
	builder.WriteString("condition_multiplier=")
	builder.WriteString(fmt.Sprintf("%v", _m.ConditionMultiplier))
	builder.WriteString(", ")
	if v := _m.PricingRuleID; v != nil {
