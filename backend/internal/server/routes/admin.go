...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.GET("/:id/model-rates/:group_id", h.Admin.User.GetModelRateOverrides)
		users.PUT("/:id/model-rates/:group_id", h.Admin.User.SetModelRateOverrides)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/model-display", h.Admin.Setting.GetModelDisplayConfig)
		adminSettings.PUT("/model-display", h.Admin.Setting.UpdateModelDisplayConfig)
